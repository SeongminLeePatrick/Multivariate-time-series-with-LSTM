...
class TimeSeriesTensor(UserDict):
    ...
    def __init__(self, dataset, target, H, tensor_structure, drop_incomplete=True):
        self.dataset = dataset
        self.target = target
        self.tensor_structure = tensor_structure
        self.tensor_names = list(tensor_structure.keys())

        self.dataframe = self._shift_data(H, drop_incomplete)
        self.data = self._df2tensors(self.dataframe)

    def _shift_data(self, H, drop_incomplete):
